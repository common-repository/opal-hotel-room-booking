...
if ( ! class_exists( 'OpalHotel' ) ) {
	...
	final class OpalHotel {
		...
		public function init_constants(){
			...
			$this->set_define( 'OPALHOTEL_VERSION', '1.2.5' );
			/* option group */
			...
			$this->set_define( 'OPALHOTEL_CPT_OFF', 'opalhotel_offer' );
		...
		public function includes() {
			...
			$this->_include( 'post-types/class-opalhotel-post-type-offers.php' );
		...
		public function load_textdomain() {
			...
			/**
			 * Re-check and load plugin textdomain.
			 * @since 1.2
			 * @author Andy Hoang Huu
			 */
			$locale = is_admin() && function_exists( 'get_user_locale' ) ? get_user_locale() : get_locale();
			$locale = apply_filters( 'plugin_locale', $locale, 'opal-hotel-room-booking' );

			unload_textdomain( 'opal-hotel-room-booking' );
			load_textdomain( 'opal-hotel-room-booking', WP_LANG_DIR . '/opal-hotel-room-booking/opal-hotel-room-booking-' . $locale . '.mo' );

			load_plugin_textdomain( 'opal-hotel-room-booking', false, dirname( OPALHOTEL_FILE ) . '/languages' );
		}
