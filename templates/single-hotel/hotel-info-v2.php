...
<div class="opalhotel-hotel-info hotel-info-v2">
	...
	<?php if ( $hotel->image ) : ?>
        <div class="hotel-feature-image">
            <img src="<?php echo esc_url( $hotel->image ) ?>" width="100" height="100" alt="<?php esc_attr( get_the_title( $post->ID ) ) ?>"/>
        </div>
	<?php endif; ?>
    <div class="meta">
        <ul>
            <li class="hotel-meta-type">
    ...
    <footer class="action">
        <div class="pull-left">
            <a href="<?php echo esc_url( wp_login_url() ) ?>" data-id="<?php echo esc_attr( $post->ID ) ?>" data-nonce="<?php echo wp_create_nonce( 'opalhotel-toggle-nonce' ); ?>"
               class="opalhotel-pre-add-wishlist <?php echo esc_attr( is_user_logged_in() ? 'opalhotel-toggle-favorite' : 'opalhotel-need-login' ) ?>">
        ...
        <div class="pull-right">
            <a href="javascript:void(0)" class="opalhotel-share" id="<?php echo esc_attr( uniqid() ) ?>" data-id="<?php echo esc_attr( 'opalhotel-share-' . $room_id ) ?>"
               data-title="<?php esc_attr_e( 'Let\'s share', 'opal-hotel-room-booking' ) ?>"><i class="fa fa-share-alt" aria-hidden="true"></i></a>
    ...
    <div class="opalhotel-share-content" id="<?php echo esc_attr( 'opalhotel-share-' . $room_id ) ?>">
        <ul class="opalhotel-single-share">
            ...
            <li>
                <a href="<?php echo esc_attr( get_the_permalink() ) ?>" class="opalhotel-twitter-share" data-text="<?php echo esc_attr( get_the_title() ) ?>"
                   data-image="<?php echo esc_attr( get_the_post_thumbnail_url() ) ?>"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            </li>
            <li>
                <a href="<?php echo esc_attr( get_the_permalink() ) ?>" class="opalhotel-pinterest-share" data-text="<?php echo esc_attr( get_the_title() ) ?>"
                   data-image="<?php echo esc_attr( get_the_post_thumbnail_url() ) ?>"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a>
            </li>
        </ul>
    </div>
</div>
