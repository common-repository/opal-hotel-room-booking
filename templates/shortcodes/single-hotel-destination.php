...
<div class="opalhotel-single-destination">
	<div class="thumbnail">
		...
		<?php if ( isset( $attach[0] ) ) : ?>
			<img src="<?php echo esc_url( $attach[0] ) ?>" alt="<?php echo esc_attr( get_the_title( $thumb_id ) ) ?>" />
		<?php endif; ?>
			...
			<div class="title">
				...
				<div class="meta">
					<span class="hotel-count">
						<?php printf( translate_nooped_plural( _n_noop('%s hotel', '%s hotels', 'opal-hotel-room-booking'), count( $hotels ), 'opal-hotel-room-booking' ), count( $hotels ) ); ?>
					</span>
