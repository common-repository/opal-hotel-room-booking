...
$stars           = ! empty( $_REQUEST['hotel-stars'] ) ? $_REQUEST['hotel-stars'] : [];
$amenities_array = ! empty( $_REQUEST['amenities'] ) ? $_REQUEST['amenities'] : [];
$rating          = ! empty( $_REQUEST['rating'] ) ? $_REQUEST['rating'] : [];
?>
...
<div class="opalhotel-ajax-filter-hotel">
    ...
    <div class="filter-section filter-section-price">
        ...
        <div class="price">
			<?php echo opalhotel_slide_ranger_template( [
				'id'        => 'price',
    ...
    <div class="filter-section filter-section-stars">
        <h4 class="section-title">
        ...
        <ul>
            <li>
                ...
                <label for="hotel-stars-5"><?php printf( '%s', opalhotel_print_hotel_star( 5, false ) ) ?></label>
            ...
            <li>
                ...
                <label for="hotel-stars-4"><?php printf( '%s', opalhotel_print_hotel_star( 4, false ) ) ?></label>
            ...
            <li>
                ...
                <label for="hotel-stars-3"><?php printf( '%s', opalhotel_print_hotel_star( 3, false ) ) ?></label>
            ...
            <li>
                ...
                <label for="hotel-stars-2"><?php printf( '%s', opalhotel_print_hotel_star( 2, false ) ) ?></label>
            ...
            <li>
                ...
                <label for="hotel-stars-1"><?php printf( '%s', opalhotel_print_hotel_star( 1, false ) ) ?></label>
                <span class="count"><?php printf( '%s', opalhotel_count_hotel_star( 1 ) ) ?></span>
            </li>
        </ul>
    </div>
    <div class="filter-section filter-section-amenities">
        <h4 class="section-title">
		...
		<?php if ( $amenities ) : ?>
            ...
            <ul>
				<?php foreach ( $amenities as $amenity ) : ?>
                    <li>
                        <input type="checkbox" name="amenities[]" value="<?php echo esc_attr( $amenity->ID ) ?>"
                               id="amenities-<?php echo esc_attr( $amenity->ID ) ?>" <?php echo esc_attr( in_array( $amenity->ID, $amenities_array ) ? ' checked' : '' ) ?>/>
    ...
    <div class="filter-section filter-section-rating">
        ...
        <ul>
            <li>
                ...
                <label for="hotel-rating-5"><?php printf( '%s', opalhotel_print_rating( 5, true ) ) ?></label>
            ...
            <li>
                ...
                <label for="hotel-rating-4"><?php printf( '%s', opalhotel_print_rating( 4, true ) ) ?></label>
            ...
            <li>
                ...
                <label for="hotel-rating-3"><?php printf( '%s', opalhotel_print_rating( 3, true ) ) ?></label>
            ...
            <li>
                ...
                <label for="hotel-rating-2"><?php printf( '%s', opalhotel_print_rating( 2, true ) ) ?></label>
            ...
            <li>
                ...
                <label for="hotel-rating-1"><?php printf( '%s', opalhotel_print_rating( 1, true ) ) ?></label>
